...
# Configuraciones ADC1410 Syzygy A
...
set_property -dict { PACKAGE_PIN W13  IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_12 }]; #IO_L20N_T3 Sch=syzygy_b_d_n[1]
set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_13 }]; #IO_L20P_T3 Sch=syzygy_b_d_p[1]
...
set_property -dict { PACKAGE_PIN AB15 IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_10 }]; #IO_L24N_T3 Sch=syzygy_b_d_n[3]
set_property -dict { PACKAGE_PIN AB14 IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_11 }]; #IO_L24P_T3 Sch=syzygy_b_d_p[3]
...
set_property -dict { PACKAGE_PIN V15  IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_8 }]; #IO_L19N_T3_VREF Sch=syzygy_b_d_n[5]
set_property -dict { PACKAGE_PIN V14  IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_9 }]; #IO_L19P_T3 Sch=syzygy_b_d_p[5]
set_property -dict { PACKAGE_PIN AB22 IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_2 }]; #IO_L7N_T1 Sch=syzygy_b_d_n[6]
set_property -dict { PACKAGE_PIN AA22 IOSTANDARD LVCMOS18 } [get_ports { o_dac_enable }]; #IO_L7P_T1 Sch=syzygy_b_d_p[6]
set_property -dict { PACKAGE_PIN Y21  IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_6 }]; #IO_L9N_T1_DQS Sch=syzygy_b_d_n[7]
set_property -dict { PACKAGE_PIN Y20  IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_7 }]; #IO_L9P_T1_DQS Sch=syzygy_b_d_p[7]
...
set_property -dict { PACKAGE_PIN AA18 IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_4 }]; #IO_L12N_T1_MRCC Sch=syzygy_b_s[16]
set_property -dict { PACKAGE_PIN AA19 IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_5 }]; #IO_L11N_T1_SRCC Sch=syzygy_b_s[17]
set_property -dict { PACKAGE_PIN Y18  IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_1 }]; #IO_L12P_T1_MRCC Sch=syzygy_b_s[18]
set_property -dict { PACKAGE_PIN Y19  IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_0 }]; #IO_L11P_T1_SRCC Sch=syzygy_b_s[19]
set_property -dict { PACKAGE_PIN AB20 IOSTANDARD LVCMOS18 } [get_ports { o_dac_data_3 }]; #IO_L10N_T1 Sch=syzygy_b_s[20]
