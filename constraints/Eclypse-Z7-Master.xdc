...
## Pmod Header JA
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { o_tx_0 }]; #IO_0 Sch=ja1_fpga
...
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { o_tx_1 }]; #IO_L1P_T0_AD0P Sch=ja4_fpga
