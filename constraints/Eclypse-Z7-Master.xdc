...
## Pmod Header JA
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { o_relation[0] }]; #IO_0 Sch=ja1_fpga
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { o_relation[1] }]; #IO_25 Sch=ja2_fpga
set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { o_relation[2] }]; #IO_L1N_T0_AD0N Sch=ja3_fpga
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { o_relation[3] }]; #IO_L1P_T0_AD0P Sch=ja4_fpga
set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { o_relation[4] }]; #IO_L2N_T0_AD8N Sch=ja7_fpga
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { o_relation[5] }]; #IO_L2P_T0_AD8P Sch=ja8_fpga
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { o_relation[6] }]; #IO_L3N_T0_DQS_AD1N Sch=ja9_fpga
set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { o_relation[7] }]; #IO_L3P_T0_DQS_AD1P Sch=ja10_fpga

## Pmod Header JB
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { o_relation[8] }]; #IO_L4N_T0 Sch=jb1_fpga
set_property -dict { PACKAGE_PIN D16   IOSTANDARD LVCMOS33 } [get_ports { o_relation[9] }]; #IO_L4P_T0 Sch=jb2_fpga
set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { o_relation[10] }]; #IO_L5N_T0_AD9N Sch=jb3_fpga
...
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { o_relation[13] }]; #IO_L6P_T0 Sch=jb8_fpga
